          ...
          <div className="flex justify-center sm:justify-start">
            <button className="group text-white w-fit px-6 py-3 my-2 flex items-cenetr rounded-md bg-gradient-to-l from-[#47B0AC] to-black-100 cursor-pointer">
              ...
              <span className="group-hover:rotate-90 duration-300">
                <ImArrowRight size={25} className="ml-1" />
              </span>
            </button>
          </div>
        </div>
        <div>
          <img src={HeroImage} alt="Jack Glazer playing the guitar at a live event" className="rounded-2xl mx-auto w-2/3 md:w-[10] mt-4 sm:mt-0" />
        </div>
      </div>
    </div>
  );
